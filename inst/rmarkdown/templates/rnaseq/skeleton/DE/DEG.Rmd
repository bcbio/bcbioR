...
-   Aim: `r aim`
-   Comparison: `r ifelse(is.na(subset_value) | is.null(subset_value), paste0(numerator, ' vs. ', denominator), paste0(subset_value, ': ', numerator, ' vs. ', denominator))`

```{r create_filenames}

if (!is.null(subset_value) & !is.na(subset_value)){
